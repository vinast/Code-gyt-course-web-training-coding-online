...
var validation$x = {
  ...
  length({ name, args: [first = 0, second = Infinity] }) {
    ...
    if (min3 == 0 && max3) {
      return `${sentence(name)} ${max3} simvoldan ki\xE7ik v\u0259 ya ona b\u0259rab\u0259r olmal\u0131d\u0131r.`;
    }
    if (min3 && max3 === Infinity) {
      return `${sentence(name)} ${min3} simvoldan b\xF6y\xFCk v\u0259 ya ona b\u0259rab\u0259r olmal\u0131d\u0131r.`;
    }
...
var validation$k = {
  ...
  date_after({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} mez\u0151nek ${date2(args[0])} ut\xE1n kell lennie.`;
    }
  ...
  date_between({ name, args }) {
    return `${sentence(name)} mez\u0151nek ${date2(args[0])} \xE9s ${args[1]} k\xF6z\xF6tt kell lennie`;
  },
  email: "K\xE9rj\xFCk, \xE9rv\xE9nyek email c\xEDmet adjon meg.",
  ends_with({ name, args }) {
  ...
  length({ name, args: [first = 0, second = Infinity] }) {
    ...
    return `${sentence(name)} mez\u0151nek ${min3} \xE9s ${max3} karakter k\xF6z\xF6tt kell lennie.`;
  },
  matches({ name }) {
    return `${sentence(name)} nem enged\xE9lyezett \xE9rt\xE9k.`;
  },
  ...
  url() {
    return `K\xE9rj\xFCk, \xE9rv\xE9nyes URL-t adjon meg.`;
  }
};
...
var validation$d = {
  ...
  length({ name, args: [first = 0, second = Infinity] }) {
    ...
    if (min3 == 0 && max3) {
      return `Pole ${sentence(name)} musi zawiera\u0107 ${max3} lub mniej znak\xF3w.`;
    }
    if (min3 && max3 === Infinity) {
      return `Pole ${sentence(name)} musi zawiera\u0107 ${min3} lub wi\u0119cej znak\xF3w.`;
    }
    return `Pole ${sentence(name)} musi mie\u0107 ${min3}-${max3} znak\xF3w.`;
  },
  matches({ name }) {
...
var validation$b = {
  ...
  date_between({ name, args }) {
    return `${sentence(name)} trebuie s\u0103 fie \xEEntre ${date2(args[0])} \u0219i ${date2(args[1])}`;
  },
  ...
  length({ name, args: [first = 0, second = Infinity] }) {
    ...
    return `${sentence(name)} trebuie s\u0103 aib\u0103 \xEEntre ${min3} \u0219i ${max3} caractere.`;
  },
  matches({ name }) {
    return `${sentence(name)} nu este o valoare acceptat\u0103.`;
  },
...
var validation$7 = {
  ...
  date_after({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} m\xE5ste vara efter ${date2(args[0])}.`;
    }
  ...
  date_before({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} m\xE5ste vara f\xF6re ${date2(args[0])}.`;
    }
  ...
  date_between({ name, args }) {
    return `${sentence(name)} m\xE5ste vara mellan ${date2(args[0])} och ${date2(args[1])}`;
  },
  ...
  length({ name, args: [first = 0, second = Infinity] }) {
    ...
    if (min3 == 0 && max3) {
      return `${sentence(name)} m\xE5ste vara ${max3} tecken eller f\xE4rre.`;
    }
    if (min3 && max3 === Infinity) {
      return `${sentence(name)} m\xE5ste vara ${min3} tecken eller fler.`;
    }
    return `${sentence(name)} m\xE5ste vara mellan ${min3} och ${max3} tecken.`;
  },
  matches({ name }) {
    return `${sentence(name)} \xE4r inte ett godk\xE4nt v\xE4rde.`;
  },
  ...
  url() {
    return `Var god fyll i en giltig l\xE4nk.`;
  }
};
