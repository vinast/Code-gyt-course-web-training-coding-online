...
var _withScopeId$3 = (n) => (pushScopeId("data-v-09dad912"), n = n(), popScopeId(), n);
...
var RowsSelector = _export_sfc(_sfc_main$5, [["__scopeId", "data-v-09dad912"]]);
...
var _withScopeId = (n) => (pushScopeId("data-v-8c691ab2"), n = n(), popScopeId(), n);
...
var _hoisted_8 = _withScopeId(() => createBaseVNode("div", { class: "vue3-easy-data-table__loading-mask" }, null, -1));
var _hoisted_9 = { class: "loading-entity" };
var _hoisted_10 = {
  key: 1,
...
var _hoisted_13 = { class: "pagination__items-index" };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        !_ctx.hideFooter ? (openBlock(), createElementBlock("div", _hoisted_11, [
          ...
          createBaseVNode("div", _hoisted_13, toDisplayString(`${unref(currentPageFirstIndex)}\u2013${unref(currentPageLastIndex)}`) + " " + toDisplayString(unref(rowsOfPageSeparatorMessage)) + " " + toDisplayString(unref(totalItemsLength)), 1),
...
var DataTable = _export_sfc(_sfc_main, [["__scopeId", "data-v-8c691ab2"]]);
if (typeof window !== "undefined" && window.Vue) {
  window.Vue.createApp({}).component("Vue3EasyDataTable", DataTable);
}

// dep:vue3-easy-data-table
var vue3_easy_data_table_default = DataTable;
export {
  vue3_easy_data_table_default as default
};
