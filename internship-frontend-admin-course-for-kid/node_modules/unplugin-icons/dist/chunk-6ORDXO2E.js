...
var JSXCompiler = async (svg, collection, icon, options) => {
  const svgr = (await Promise.resolve().then(() => _chunkGMAU6NZDjs.__toModule.call(void 0, _chunkGMAU6NZDjs.__require.call(void 0, "@svgr/core")))).default;
  let res = await svgr(svg, {}, { componentName: _chunkPZ3KAP26js.camelize.call(void 0, `${collection}-${icon}`) });
