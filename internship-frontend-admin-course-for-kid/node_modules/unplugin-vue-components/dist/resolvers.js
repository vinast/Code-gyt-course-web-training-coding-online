...
function getStyleDir(compName) {
  ...
  if (!styleDir)
    styleDir = _chunkYBT6MD7Sjs.kebabCase.call(void 0, compName);
  return styleDir;
}
...
function IduxResolver(options = {}) {
  return (name) => {
    if (name.match(/^Ix[A-Z]/)) {
      ...
      const compName = name.slice(2);
      const kebabCaseName = _chunkYBT6MD7Sjs.kebabCase.call(void 0, compName);
  ...
  return (name) => {
    ...
    if (name.startsWith("Van")) {
      ...
      return {
        ...
        path: "vant/es",
        sideEffects: importStyle ? `vant/es/${_chunkYBT6MD7Sjs.kebabCase.call(void 0, partialName)}/style` : void 0
      };
    }
  };
}
  ...
  return (name) => {
    ...
    if (name.startsWith("Var")) {
      ...
      if (importStyle || importCss) {
        if (importStyle === "less" || importLess)
          sideEffects.push(`@varlet/ui/es/${_chunkYBT6MD7Sjs.kebabCase.call(void 0, partialName)}/style/less.js`);
        else
          sideEffects.push(`@varlet/ui/es/${_chunkYBT6MD7Sjs.kebabCase.call(void 0, partialName)}/style`);
      }
      return {
...
var formatters = {
  "kebab-case": _chunkYBT6MD7Sjs.kebabCase,
  "camelCase": _chunkYBT6MD7Sjs.camelCase,
  "PascalCase": _chunkYBT6MD7Sjs.pascalCase
};
var peerPaths = new Map();
function assertPeerPath(peerPath) {
  if (!peerPaths.has(peerPath)) {
    try {
      _chunkYBT6MD7Sjs.resolveImportPath.call(void 0, peerPath);
...
function getCompDir(compName) {
  ...
  for (let i = 0; i < total; i++) {
    ...
    if (compName.match(matcher.pattern)) {
      compPath = `${matcher.compDir}/${_chunkYBT6MD7Sjs.kebabCase.call(void 0, compName)}.vue`;
      break;
    }
  }
  if (!compPath)
    compPath = _chunkYBT6MD7Sjs.kebabCase.call(void 0, compName);
  return compPath;
}
...
exports.AntDesignVueResolver = AntDesignVueResolver; exports.ElementPlusResolver = ElementPlusResolver; exports.ElementUiResolver = ElementUiResolver; exports.HeadlessUiResolver = HeadlessUiResolver; exports.IduxResolver = IduxResolver; exports.LibraryResolver = _chunkYBT6MD7Sjs.LibraryResolver; exports.NaiveUiResolver = NaiveUiResolver; exports.PrimeVueResolver = PrimeVueResolver; exports.QuasarResolver = QuasarResolver; exports.VantResolver = VantResolver; exports.VarletUIResolver = VarletUIResolver; exports.VeuiResolver = VeuiResolver; exports.ViewUiResolver = ViewUiResolver; exports.VueUseComponentsResolver = VueUseComponentsResolver; exports.VuetifyResolver = VuetifyResolver; exports.tryLoadVeturTags = _chunkYBT6MD7Sjs.tryLoadVeturTags;
