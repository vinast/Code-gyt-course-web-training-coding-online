...
async function generateDeclaration(ctx, root, filepath) {
  const imports = Object.fromEntries(Object.values(_chunk7T67WII5js.__spreadValues.call(void 0, _chunk7T67WII5js.__spreadValues.call(void 0, {}, ctx.componentNameMap), ctx.componentCustomMap)).map(({ path, name, importName }) => {
    if (!name)
      return void 0;
    const related = _utils.slash.call(void 0, path).startsWith("/") ? `./${_path.relative.call(void 0, _path.dirname.call(void 0, filepath), path)}` : path;
  ...
  return async (code, id, path, query) => {
    ...
    for (const match of code.matchAll(/_c\([\s\n\t]*['"](.+?)["']([,)])/g)) {
      ...
      if (match.index != null && matchedName && !matchedName.startsWith("_")) {
        ...
        debug2(`| ${matchedName}`);
        const name = _chunkYBT6MD7Sjs.pascalCase.call(void 0, matchedName);
        ...
        if (component) {
          ...
          head.push(_chunkYBT6MD7Sjs.stringifyComponentImport.call(void 0, _chunk7T67WII5js.__spreadProps.call(void 0, _chunk7T67WII5js.__spreadValues.call(void 0, {}, component), { name: var_name }), ctx));
          no += 1;
    ...
    if (!head.length)
      return null;
    s.prepend(`${_chunkYBT6MD7Sjs.DISABLE_COMMENT}${head.join(";")};`);
...
var Context = class {
  ...
  async findComponent(name, excludePaths = [], rawName) {
